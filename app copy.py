...
def upload_form():
    ...
    if request.method == 'POST':
       ...
       # ロゴ画像を取得（任意）
        ...
        # テキストを描画
        draw_1.text((final_width - right_text_width_1 - 15, final_height - right_text_height_1 - 115), text_input_3, font=font_16px, fill="#90005D")
        ...
        right_text_background_2 = (final_width - right_text_width_2 - 20, final_height - right_text_height_2 - 60, final_width - 10, final_height - 30)
        ...
        # テキストを描画
        draw_1.text((final_width - right_text_width_2 - 15, final_height - right_text_height_2 - 55), text_input_4, font=font_16px, fill="#90005D")
        # テキストを5px下に移動
        ...
        final_width_2 = 495
        final_height_2 = 495
        background_2 = Image.new('RGB', (final_width_2, final_height_2), (255, 255, 255))  # 背景色#fff

        img_position_2 = (final_width_2 - img_2.width - 40, (final_height_2 - img_2.height) // 2)  # 右寄せ40px
        ...
        if logo_img:
           logo_size = (100, 100)  # ロゴのサイズを指定（必要に応じて調整）
           logo_img.thumbnail(logo_size, Image.Resampling.LANCZOS)  # ロゴのサイズ調整
           background_2.paste(logo_img, (10, 10), logo_img.convert('RGBA'))  # ロゴを左上に貼り付け
        ...
        # 圧縮品質を調整しながら画像を保存（100KB以下になるまで繰り返す）
    ...
    return render_template('upload_form.html', img_base64_1=img_base64_1, img_base64_2=img_base64_2, text_input_1=text_input_1, text_input_2=text_input_2, text_input_3=text_input_3, text_input_4=text_input_4)
